...
class BraintreeHelperTest < Test::Unit::TestCase
  ...
  def test_basic_helper_fields
    assert_form_field 'key_id', '776320'
    assert_form_field 'orderid', 'order-500'
    assert_form_field 'amount', '5.00'
    assert_form_field 'time', @helper.current_time
    assert_form_field 'hash', @helper.generate_md5hash
    assert_form_field 'redirect', 'https://mysite.com/payment_notification'
  end
  ...
  def test_description_fields
    ...
    assert_form_field 'orderdescription', 'An armada of rubber ducks'
    assert_form_field 'descriptor', 'Ducks R Us'
    assert_form_field 'descriptor_phone', '(555)555-5555'
  end

  def test_customer_fields
    @helper.customer :first_name => 'Cody', :last_name => 'Fauser', :email => 'cody@example.com', :phone => '(555)555-5555'
    assert_form_field 'firstname', 'Cody'
    assert_form_field 'lastname', 'Fauser'
    assert_form_field 'email', 'cody@example.com'
    assert_form_field 'phone', '(555)555-5555'
  end

  def test_customer_vault_fields
    @helper.customer_id = 'customer-1'
    @helper.storage_operation = 'add_customer'
    assert_form_field 'customer_vault_id', 'customer-1'
    assert_form_field 'customer_vault', 'add_customer'
  end

  def test_receipts
    @helper.send_receipt = true
    assert_form_field 'customer_receipt', 'true'
  end
  ...
  def test_billing_address
    ...
    assert_form_field 'address1', '1 My Street'
    assert_form_field 'address2', 'Apt. 1'
    assert_form_field 'city', 'Leeds'
    assert_form_field 'state', 'Yorkshire'
    assert_form_field 'zip', 'LS2 7EE'
    assert_form_field 'country', 'CA'
  end
  ...
  def test_shipping_address
    ...
    assert_form_field 'shipping_firstname', 'Jon'
    assert_form_field 'shipping_lastname', 'Shea'
    assert_form_field 'shipping_city', 'London'
    assert_form_field 'shipping_address1', '1 My Street'
    assert_form_field 'shipping_address2', 'Apt. 1'
    assert_form_field 'shipping_state', 'Whales'
    assert_form_field 'shipping_zip', 'LS2 7E1'
    assert_form_field 'shipping_country', 'UK'
  end
  ...
  def test_production_mode
    ...
    assert_form_field 'key_id', 'my-key-id'
  end
end
